 ...
 */
public class LikeTypeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.liketype_main);
        like_top = (Toolbar)findViewById(R.id.like_topbar);
        ...
        like_back = (ImageView)findViewById(R.id.like_top_img_btn);
        ...
        like_top.setBackgroundResource(skinManager.getCurrentSkinRes());
    }
